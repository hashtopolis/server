...
CREATE INDEX IF NOT EXISTS Task_isArchived_priority_taskId_idx ON Task(isArchived, priority DESC, taskId ASC);
...
CREATE INDEX IF NOT EXISTS TaskWrapper_isArchived_priority_taskWrapperId_idx ON TaskWrapper(isArchived, priority DESC, taskWrapperId ASC);

...
INSERT INTO `HashType` (`hashTypeId`, `description`, `isSalted`, `isSlowHash`) VALUES
  ...
  (30600, 'bcrypt(sha256($pass)) / bcryptsha256', 0, 1),
  (30601, 'bcrypt-sha256 v2 bcrypt(HMAC-SHA256($pass))', 0, 1),
  ...
  (33800, 'WBB4 (Woltlab Burning Board) Plugin [bcrypt(bcrypt($pass))]', 0, 1),
  (33900, 'Citrix NetScaler (PBKDF2-HMAC-SHA256)', 0, 1),
  (34000, 'Argon2', 0, 1),
  (34100, 'LUKS v2 argon2id + SHA-256 + AES', 0, 1),
  ...
  (70100, 'scrypt [Bridged: Scrypt-Jane ROMix]', 0, 1),

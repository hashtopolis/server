...
INSERT INTO `HashType` (`hashTypeId`, `description`, `isSalted`, `isSlowHash`) VALUES
  ...
  (21600, 'Web2py pbkdf2-sha512', 1, 0),
  (21700, 'Electrum Wallet (Salt-Type 4)', 1, 0),
  (21800, 'Electrum Wallet (Salt-Type 5)', 1, 0),
  ...
  (22600, 'Telegram Desktop App Passcode (PBKDF2-HMAC-SHA1)', 1, 0),
  ...
  (23200, 'XMPP SCRAM PBKDF2-SHA1', 1, 0),
  ...
  (24410, 'PKCS#8 Private Keys (PBKDF2-HMAC-SHA1 + 3DES/AES)', 1, 0),
  (24420, 'PKCS#8 Private Keys (PBKDF2-HMAC-SHA256 + 3DES/AES)', 1, 0),
  (24500, 'Telegram Desktop >= v2.1.14 (PBKDF2-HMAC-SHA512)', 1, 0),
  (24600, 'SQLCipher', 0, 0),
  (24700, 'Stuffit5', 0, 0),
  ...
  (26401, 'AES-128-ECB NOKDF (PT = $salt, key = $pass)', 1, 0),
  (26402, 'AES-192-ECB NOKDF (PT = $salt, key = $pass)', 1, 0),
  (26403, 'AES-256-ECB NOKDF (PT = $salt, key = $pass)', 1, 0),
  (26500, 'iPhone passcode (UID key + System Keybag)', 0, 0),
  (26600, 'MetaMask Wallet', 0, 0),
  ...
  (27200, 'Ruby on Rails Restful Auth (one round, no sitekey)', 0, 0),

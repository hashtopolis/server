...
INSERT INTO `HashType` (`hashTypeId`, `description`, `isSalted`) VALUES
  ...
  (400,'phpass, MD5(Wordpress), MD5(Joomla)',0),
   (400,'phpass, MD5(phpBB3)',0),
    ...
    (1431,'base64(sha256(unicode($pass))) 6',0),
    ...
    (1600,'md5apr1, MD5(APR), Apache MD5 2',0),
    (1700,'SHA512',0),
    ...
    (1800,'sha512crypt, SHA512(Unix) 2',0),
    (2100,'Domain Cached Credentials 2 (DCC2), MS Cache 2',0),
    ...
    (4800,'MD5(Chap), iSCSI CHAP authentication 7',1),
    ...
    (6000,'RipeMD160',0),
    (6100,'Whirlpool',0),
    (6211,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + AES',0),
    (6211,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Serpent',0),
    (6211,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Twofish',0),
    (6212,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + AES-Twofish',0),
    (6213,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + AES-Twofish-Serpent',0),
    (6212,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Serpent-AES',0),
    (6213,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Serpent-Twofish-AES',0),
    (6212,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Twofish-Serpent',0),
    (6221,'TrueCrypt 5.0+ SHA512 + AES',0),
    (6221,'TrueCrypt 5.0+ SHA512 + Serpent',0),
    (6221,'TrueCrypt 5.0+ SHA512 + Twofish',0),
    (6222,'TrueCrypt 5.0+ SHA512 + AES-Twofish',0),
    (6223,'TrueCrypt 5.0+ SHA512 + AES-Twofish-Serpent',0),
    (6222,'TrueCrypt 5.0+ SHA512 + Serpent-AES',0),
    (6223,'TrueCrypt 5.0+ SHA512 + Serpent-Twofish-AES',0),
    (6222,'TrueCrypt 5.0+ SHA512 + Twofish-Serpent',0),
    (6231,'TrueCrypt 5.0+ Whirlpool + AES',0),
    (6231,'TrueCrypt 5.0+ Whirlpool + Serpent',0),
    (6231,'TrueCrypt 5.0+ Whirlpool + Twofish',0),
    (6232,'TrueCrypt 5.0+ Whirlpool + AES-Twofish',0),
    (6233,'TrueCrypt 5.0+ Whirlpool + AES-Twofish-Serpent',0),
    (6232,'TrueCrypt 5.0+ Whirlpool + Serpent-AES',0),
    (6233,'TrueCrypt 5.0+ Whirlpool + Serpent-Twofish-AES',0),
    (6232,'TrueCrypt 5.0+ Whirlpool + Twofish-Serpent',0),
    (6241,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + AES + boot',0),
    (6241,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Serpent + boot',0),
    (6241,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Twofish + boot',0),
    (6242,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + AES-Twofish + boot',0),
    (6243,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + AES-Twofish-Serpent + boot',0),
    (6242,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Serpent-AES + boot',0),
    (6243,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Serpent-Twofish-AES + boot',0),
    (6242,'TrueCrypt 5.0+ PBKDF2-HMAC-RipeMD160 + Twofish-Serpent + boot',0),
    (6300,'AIX {smd5}',0),
    (6400,'AIX {ssha256}',0),
    (6500,'AIX {ssha512}',0),
    ...
    (7400,'sha256crypt, SHA256(Unix) 2',0),
    ...
    (13400,'Keepass 1 AES / without keyfile',0),
    (13400,'Keepass 2 AES / without keyfile',0),
    (13400,'Keepass 1 Twofish / with keyfile',0),
    (13400,'Keepass 2 AES / with keyfile',0),
    (13500,'PeopleSoft PS_TOKEN',0),
    (13600,'WinZip',0),
    (13800,'Windows 8+ phone PIN/Password',0),
   (13900,'OpenCart',1),
   (14000,'DES (PT = $salt, key = $pass) 8',1),
  (14100,'3DES (PT = $salt, key = $pass) 9',1),
(14400,'sha1(CX)',1),
(14600,'LUKS 10',0),

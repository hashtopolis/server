...
if (!isset($PRESENT["v1.0.0-rainbow4_migration_to_migrations"])) {
  if (!Util::databaseTableExists("_sqlx_migrations")) {
    ...
    Factory::getAgentFactory()->getDB()->query("INSERT INTO `_sqlx_migrations` VALUES (20251127000000,'initial','2025-11-28 14:29:13',1,0x87B4F9CE14A0C5A131A84D96044E89BAD641D0043E19141341C2DE2D307A25B748EF4F356CF4E0ACE439F84EC6C8F77A," . time() . ");");
  }

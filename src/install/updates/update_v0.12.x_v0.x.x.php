...
if (!isset($PRESENT["v0.12.x_hashTypes_3"])) {
  $hashtypes = [
    new HashType(23300, 'Apple iWork', 0, 0),
    new HashType(23500, 'AxCrypt 2 AES-128', 0, 0),
    new HashType(23600, 'AxCrypt 2 AES-256', 0, 0),
    new HashType(23900, 'BestCrypt v3 Volume Encryption', 0, 0),
    new HashType(23400, 'Bitwarden', 0, 0),
    new HashType(24900, 'Dahua Authentication MD5', 0, 0),
    new HashType(25900, 'KNX IP Secure - Device Authentication Code', 0, 0),
    new HashType(24100, 'MongoDB ServerKey SCRAM-SHA-1', 0, 0),
    new HashType(24200, 'MongoDB ServerKey SCRAM-SHA-256', 0, 0),
    new HashType(26000, 'Mozilla key3.db', 0, 0),
    new HashType(26100, 'Mozilla key4.db', 0, 0),
    new HashType(25300, 'MS Office 2016 - SheetProtection', 0, 0),
    new HashType(25400, 'PDF 1.4 - 1.6 (Acrobat 5 - 8) - edit password', 0, 0),
    new HashType(24410, 'PKCS#8 Private Keys (PBKDF2-HMAC-SHA1 + 3DES/AES)', 0, 0),
    ...
    new HashType(21501, 'SolarWinds Orion v2', 0, 0),
    new HashType(24, 'SolarWinds Serv-U', 0, 0),
    new HashType(24600, 'SQLCipher', 0, 0),
    new HashType(25500, 'Stargazer Stellar Wallet XLM', 0, 0),

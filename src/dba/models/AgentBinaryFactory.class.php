...
class AgentBinaryFactory extends AbstractModelFactory {
  ...
  function getNullObject() {
    $o = new AgentBinary(-1, null, null, null, null, null);
    return $o;
  }
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new AgentBinary($dict['agentBinaryId'], $dict['type'], $dict['version'], $dict['operatingSystems'], $dict['filename'], $dict['updateAvailable']);
    return $o;
  }

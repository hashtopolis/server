...
class Chunk extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['chunkId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "chunkId"];
    $dict['taskId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "taskId"];
    $dict['skip'] = ['read_only' => False, "type" => "uint64", "null" => False, "pk" => False, "protected" => False, "alias" => "skip"];
    $dict['length'] = ['read_only' => False, "type" => "uint64", "null" => False, "pk" => False, "protected" => False, "alias" => "length"];
    $dict['agentId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "agentId"];
    $dict['dispatchTime'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "dispatchTime"];
    $dict['solveTime'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "solveTime"];
    $dict['checkpoint'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "checkpoint"];
    $dict['progress'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "progress"];
    $dict['state'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "state"];
    $dict['cracked'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "cracked"];
    $dict['speed'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "speed"];

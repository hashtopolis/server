...
class FileDownload extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['fileDownloadId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "fileDownloadId", "public" => False, "reference" => False, "dba_mapping" => False];
    ...
    $dict['fileId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "fileId", "public" => False, "reference" => "File", "dba_mapping" => False];
    $dict['status'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => [-100 => "Deleted", -1 => "Failed", 0 => "Pending", 1 => "Done", ], "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "status", "public" => False, "reference" => False, "dba_mapping" => False];

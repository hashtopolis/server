...
$CONF['Agent'] = [
  'columns' => [
    ...
    ['name' => 'isActive', 'read_only' => False, 'type' => 'int'],
    ['name' => 'isTrusted', 'read_only' => False, 'type' => 'int'],
    ...
    ['name' => 'cpuOnly', 'read_only' => False, 'type' => 'int'],
...
$CONF['CrackerBinaryType'] = [
  'columns' => [
    ...
    ['name' => 'isChunkingAvailable', 'read_only' => False, 'type' => 'int'],
  ],
];
$CONF['File'] = [
  'columns' => [
    ...
    ['name' => 'isSecret', 'read_only' => False, 'type' => 'int'],
...
$CONF['Hash'] = [
  'columns' => [
    ...
    ['name' => 'isCracked', 'read_only' => False, 'type' => 'int'],
...
$CONF['Hashlist'] = [
  'columns' => [
    ...
    ['name' => 'cracked', 'read_only' => True, 'type' => 'int', 'protected' => True],
    ['name' => 'isSecret', 'read_only' => False, 'type' => 'int'],
    ['name' => 'hexSalt', 'read_only' => True, 'type' => 'int', 'alias' => UQueryHashlist::HASHLIST_HEX_SALTED],
    ['name' => 'isSalted', 'read_only' => True, 'type' => 'int'],
    ['name' => 'accessGroupId', 'read_only' => False, 'type' => 'int', 'relation' => 'AccessGroup'],
    ...
    ['name' => 'isArchived', 'read_only' => False, 'type' => 'int'],
  ],
];
$CONF['HashType'] = [
  'columns' => [
    ...
    ['name' => 'isSalted', 'read_only' => False, 'type' => 'int'],
    ['name' => 'isSlowHash', 'read_only' => False, 'type' => 'int'],
  ],
];
$CONF['HealthCheck'] = [
  'columns' => [
...
$CONF['Pretask'] = [
  'columns' => [
    ...
    ['name' => 'isSmall', 'read_only' => False, 'type' => 'int'],
    ['name' => 'isCpuTask', 'read_only' => False, 'type' => 'int'],
    ['name' => 'useNewBench', 'read_only' => True, 'type' => 'int'],
    ['name' => 'priority', 'read_only' => False, 'type' => 'int'],
    ['name' => 'maxAgents', 'read_only' => False, 'type' => 'int'],
    ['name' => 'isMaskImport', 'read_only' => False, 'type' => 'int'],
...
$CONF['Session'] = [
  'columns' => [
    ...
    ['name' => 'isOpen', 'read_only' => True, 'type' => 'int', 'protected' => True],
...
$CONF['Task'] = [
  'columns' => [
    ...
    ['name' => 'forcePipe', 'read_only' => True, 'type' => 'int'],
...
$CONF['User'] = [
  'columns' => [
    ...
    ['name' => 'isValid', 'read_only' => False, 'type' => 'int', 'null' => true],
    ['name' => 'isComputedPassword', 'read_only' => True, 'type' => 'int', 'protected' => True,],

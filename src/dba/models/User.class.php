...
class User extends AbstractModel {
  ...
  static function getFeatures() {
    ...
    $dict['passwordHash'] = ['read_only' => True, "type" => "str(256)", "null" => False, "pk" => False, "protected" => True, "alias" => "passwordHash"];
    $dict['passwordSalt'] = ['read_only' => True, "type" => "str(256)", "null" => False, "pk" => False, "protected" => True, "alias" => "passwordSalt"];
    $dict['isValid'] = ['read_only' => False, "type" => "bool", "null" => False, "pk" => False, "protected" => False, "alias" => "isValid"];
    $dict['isComputedPassword'] = ['read_only' => True, "type" => "bool", "null" => False, "pk" => False, "protected" => True, "alias" => "isComputedPassword"];
    $dict['lastLoginDate'] = ['read_only' => True, "type" => "int64", "null" => False, "pk" => False, "protected" => True, "alias" => "lastLoginDate"];
    $dict['registeredSince'] = ['read_only' => True, "type" => "int64", "null" => False, "pk" => False, "protected" => True, "alias" => "registeredSince"];
    $dict['sessionLifetime'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => False, "protected" => True, "alias" => "sessionLifetime"];

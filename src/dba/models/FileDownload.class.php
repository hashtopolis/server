...
class FileDownload extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['fileDownloadId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "fileDownloadId"];
    $dict['time'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "time"];
    $dict['fileId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "fileId"];

...
class NotificationSetting extends AbstractModel {
  ...
  static function getFeatures(): array {
    ...
    $dict['action'] = ['read_only' => False, "type" => "str(50)", "subtype" => "unset", "choices" => ["createNotification" => "Create notification", "setActive" => "Set active", "deleteNotification" => "Delete notification", ], "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "action", "public" => False, "reference" => False, "dba_mapping" => False];

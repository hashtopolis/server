...
class HashlistHashlist extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['hashlistHashlistId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "hashlistHashlistId"];
    $dict['parentHashlistId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "parentHashlistId"];
    $dict['hashlistId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "hashlistId"];

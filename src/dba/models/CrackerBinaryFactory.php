...
class CrackerBinaryFactory extends AbstractModelFactory {
  ...
  function getNullObject(): CrackerBinary {
    return new CrackerBinary(-1, null, null, null, null, null);
  }
  ...
  function createObjectFromDict(array $dict): CrackerBinary {
    ...
    $dict = $conv;
    return new CrackerBinary($dict['crackerbinaryid'], $dict['crackerbinarytypeid'], $dict['version'], $dict['downloadurl'], $dict['binaryname'], $dict['filename'] ?? null);
  }
}

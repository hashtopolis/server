...
class HashlistFactory extends AbstractModelFactory {
  ...
  function getNullObject() {
    $o = new Hashlist(-1, null, null, null, null, null, null, null, null, null, null, null, null);
    return $o;
  }
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new Hashlist($dict['hashlistId'], $dict['hashlistName'], $dict['format'], $dict['hashTypeId'], $dict['hashCount'], $dict['saltSeparator'], $dict['cracked'], $dict['isSecret'], $dict['hexSalt'], $dict['isSalted'], $dict['accessGroupId'], $dict['notes'], $dict['brainId']);
    return $o;
  }

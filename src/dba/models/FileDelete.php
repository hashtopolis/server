...
class FileDelete extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['fileDeleteId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "fileDeleteId", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['filename'] = ['read_only' => True, "type" => "str(256)", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "filename", "public" => False, "reference" => False, "dba_mapping" => False];

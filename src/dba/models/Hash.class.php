...
class Hash extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['hashId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "hashId"];
    ...
    $dict['salt'] = ['read_only' => False, "type" => "str(256)", "null" => False, "pk" => False, "protected" => False, "alias" => "salt"];
    $dict['plaintext'] = ['read_only' => False, "type" => "str(256)", "null" => False, "pk" => False, "protected" => False, "alias" => "plaintext"];

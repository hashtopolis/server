...
class Preprocessor extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['preprocessorId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => True, "protected" => True, "alias" => "preprocessorId"];
    $dict['name'] = ['read_only' => False, "type" => "str(256)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "name"];
    $dict['url'] = ['read_only' => False, "type" => "str(512)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "url"];
    $dict['binaryName'] = ['read_only' => False, "type" => "str(256)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "binaryName"];
    $dict['keyspaceCommand'] = ['read_only' => False, "type" => "str(256)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "keyspaceCommand"];
    $dict['skipCommand'] = ['read_only' => False, "type" => "str(256)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "skipCommand"];
    $dict['limitCommand'] = ['read_only' => False, "type" => "str(256)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "limitCommand"];

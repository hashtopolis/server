...
class Speed extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['speedId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "speedId", "public" => False, "reference" => False, "dba_mapping" => False];

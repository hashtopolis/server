...
class AgentZap extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['agentZapId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "agentZapId"];
    $dict['agentId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "agentId"];
    $dict['lastZapId'] = ['read_only' => False, "type" => "str(128)", "null" => False, "pk" => False, "protected" => False, "alias" => "lastZapId"];

...
class TaskDebugOutput extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['taskDebugOutputId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "taskDebugOutputId"];
    $dict['taskId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "taskId"];
    $dict['output'] = ['read_only' => True, "type" => "str(256)", "null" => False, "pk" => False, "protected" => False, "alias" => "output"];

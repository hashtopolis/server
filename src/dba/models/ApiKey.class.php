...
class ApiKey extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['apiKeyId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "apiKeyId"];
    $dict['startValid'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "startValid"];
    $dict['endValid'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "endValid"];
    $dict['accessKey'] = ['read_only' => False, "type" => "str(256)", "null" => False, "pk" => False, "protected" => False, "alias" => "accessKey"];
    $dict['accessCount'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "accessCount"];
    $dict['userId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "userId"];
    $dict['apiGroupId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "apiGroupId"];

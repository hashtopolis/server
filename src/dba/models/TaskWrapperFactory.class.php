...
class TaskWrapperFactory extends AbstractModelFactory {
  ...
  function getNullObject() {
    $o = new TaskWrapper(-1, null, null, null, null, null, null);
    return $o;
  }
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new TaskWrapper($dict['taskWrapperId'], $dict['priority'], $dict['taskType'], $dict['hashlistId'], $dict['accessGroupId'], $dict['taskWrapperName'], $dict['isArchived']);
    return $o;
  }

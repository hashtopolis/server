...
class SupertaskPretask extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['supertaskPretaskId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => True, "protected" => True, "alias" => "supertaskPretaskId"];
    $dict['supertaskId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "supertaskId"];
    $dict['pretaskId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "pretaskId"];

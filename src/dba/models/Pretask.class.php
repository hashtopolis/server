...
class Pretask extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['pretaskId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => True, "protected" => True, "alias" => "pretaskId"];
    $dict['taskName'] = ['read_only' => False, "type" => "str(100)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "taskName"];
    ...
    $dict['useNewBench'] = ['read_only' => False, "type" => "bool", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "useNewBench"];

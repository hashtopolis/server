...
class Pretask extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['pretaskId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "alias" => "pretaskId"];
    $dict['taskName'] = ['read_only' => False, "type" => "str(100)", "null" => False, "pk" => False, "alias" => "taskName"];
    ...
    $dict['color'] = ['read_only' => False, "type" => "str(20)", "null" => False, "pk" => False, "alias" => "color"];
    ...
    $dict['isMaskImport'] = ['read_only' => False, "type" => "bool", "null" => False, "pk" => False, "alias" => "isMaskImport"];

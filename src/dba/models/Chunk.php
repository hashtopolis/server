...
class Chunk extends AbstractModel {
  ...
  static function getFeatures(): array {
    ...
    $dict['state'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => [0 => "Init", 1 => "Autotune", 2 => "Running", 3 => "Paused", 4 => "Exhausted", 5 => "Cracked", 6 => "Aborted", 7 => "Quit", 8 => "Bypass", 9 => "Aborted at checkpoint", 10 => "Aborted at runtime", ], "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "state", "public" => False, "dba_mapping" => False];

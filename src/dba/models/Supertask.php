...
class Supertask extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['supertaskId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "supertaskId", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['supertaskName'] = ['read_only' => False, "type" => "str(50)", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "supertaskName", "public" => False, "reference" => False, "dba_mapping" => False];

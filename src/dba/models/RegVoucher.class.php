...
class RegVoucher extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['regVoucherId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => True, "protected" => True, "alias" => "regVoucherId"];
    $dict['voucher'] = ['read_only' => False, "type" => "str(100)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "voucher"];

...
class User extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['userId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "userId", "public" => True, "dba_mapping" => False];
    ...
    $dict['isValid'] = ['read_only' => False, "type" => "bool", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "isValid", "public" => False, "dba_mapping" => False];

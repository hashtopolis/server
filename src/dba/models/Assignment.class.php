...
class Assignment extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['assignmentId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => True, "protected" => True, "alias" => "assignmentId"];
    ...
    $dict['benchmark'] = ['read_only' => False, "type" => "str(50)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "benchmark"];

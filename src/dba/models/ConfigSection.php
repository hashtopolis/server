...
class ConfigSection extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['configSectionId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "configSectionId", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['sectionName'] = ['read_only' => False, "type" => "str(100)", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "sectionName", "public" => False, "reference" => False, "dba_mapping" => False];

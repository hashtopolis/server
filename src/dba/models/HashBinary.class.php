...
class HashBinary extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['hashBinaryId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "null" => False, "pk" => True, "protected" => True, "alias" => "hashBinaryId"];
    $dict['hashlistId'] = ['read_only' => False, "type" => "int", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "hashlistId"];
    $dict['essid'] = ['read_only' => False, "type" => "str(100)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "essid"];
    $dict['hash'] = ['read_only' => False, "type" => "str(4294967295)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "hash"];
    $dict['plaintext'] = ['read_only' => False, "type" => "str(1024)", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "plaintext"];
    $dict['timeCracked'] = ['read_only' => False, "type" => "int64", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "timeCracked"];
    $dict['chunkId'] = ['read_only' => False, "type" => "int", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "chunkId"];
    $dict['isCracked'] = ['read_only' => False, "type" => "bool", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "isCracked"];
    $dict['crackPos'] = ['read_only' => False, "type" => "int64", "subtype" => "unset", "null" => False, "pk" => False, "protected" => False, "alias" => "crackPos"];

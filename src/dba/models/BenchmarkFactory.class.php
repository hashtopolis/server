...
class BenchmarkFactory extends AbstractModelFactory {
  ...
  function getNullObject() {
    $o = new Benchmark(-1, null, null, null, null, null, null, null);
    return $o;
  }
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new Benchmark($dict['benchmarkId'], $dict['benchmarkType'], $dict['benchmarkValue'], $dict['attackParameters'], $dict['hashMode'], $dict['hardwareGroupId'], $dict['ttl'], $dict['crackerBinaryId']);
    return $o;
  }

...
class Session extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['sessionId'] = ['read_only' => True, "type" => "int", "null" => False, "pk" => True, "protected" => True, "alias" => "sessionId"];
    $dict['userId'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "userId"];
    $dict['sessionStartDate'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "sessionStartDate"];
    $dict['lastActionDate'] = ['read_only' => False, "type" => "int64", "null" => False, "pk" => False, "protected" => False, "alias" => "lastActionDate"];
    $dict['isOpen'] = ['read_only' => False, "type" => "bool", "null" => False, "pk" => False, "protected" => False, "alias" => "isOpen"];
    $dict['sessionLifetime'] = ['read_only' => False, "type" => "int", "null" => False, "pk" => False, "protected" => False, "alias" => "sessionLifetime"];
    $dict['sessionKey'] = ['read_only' => False, "type" => "str(256)", "null" => False, "pk" => False, "protected" => False, "alias" => "sessionKey"];

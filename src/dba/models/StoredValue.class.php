...
class StoredValue extends AbstractModel {
  ...
  static function getFeatures() {
    $dict = array();
    $dict['storedValueId'] = ['read_only' => True, "type" => "str(50)", "null" => False, "pk" => True, "protected" => True, "alias" => "storedValueId"];
    $dict['val'] = ['read_only' => False, "type" => "str(256)", "null" => False, "pk" => False, "protected" => False, "alias" => "val"];

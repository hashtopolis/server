...
class PretaskFactory extends AbstractModelFactory {
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new Pretask($dict['pretaskId'], $dict['taskName'], $dict['attackCmd'], $dict['chunkTime'], $dict['statusTimer'], $dict['color'], $dict['isSmall'], $dict['isCpuTask'], $dict['useNewBench'], $dict['priority'], $dict['isMaskImport'], $dict['isHidden']);
    return $o;
  }

...
class HealthCheck extends AbstractModel {
  ...
  static function getFeatures(): array {
    $dict = array();
    $dict['healthCheckId'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => True, "protected" => True, "private" => False, "alias" => "healthCheckId", "public" => False, "reference" => False, "dba_mapping" => False];
    ...
    $dict['status'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => [-1 => "Aborted", 0 => "Pending", 1 => "Completed", ], "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "status", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['checkType'] = ['read_only' => False, "type" => "int", "subtype" => "unset", "choices" => [0 => "MD5", 3200 => "Bcrypt", ], "null" => False, "pk" => False, "protected" => False, "private" => False, "alias" => "checkType", "public" => False, "reference" => False, "dba_mapping" => False];
    ...
    $dict['expectedCracks'] = ['read_only' => True, "type" => "int", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "expectedCracks", "public" => False, "reference" => False, "dba_mapping" => False];
    $dict['attackCmd'] = ['read_only' => True, "type" => "str(65535)", "subtype" => "unset", "choices" => "unset", "null" => False, "pk" => False, "protected" => True, "private" => False, "alias" => "attackCmd", "public" => False, "reference" => False, "dba_mapping" => False];

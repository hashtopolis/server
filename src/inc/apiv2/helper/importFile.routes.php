...
$app->group("/api/v2/helper/importFile", function (RouteCollectorProxy $group) { 
...
$app->group("/api/v2/helper/importFile/{id:[0-9]{14}-[0-9a-f]{32}}", function (RouteCollectorProxy $group) { 

...
class UserAPITask extends UserAPIBasic {
  ...
  private function createTask($QUERY) {
    ...
    $task = TaskUtils::createTask(
      ...
      (isset($QUERY[UQueryTask::TASK_PRIORITY])) ? int($QUERY[UQueryTask::TASK_PRIORITY]) : 0,
      (isset($QUERY[UQueryTask::TASK_MAX_AGENTS])) ? int($QUERY[UQueryTask::TASK_MAX_AGENTS]) : 0,

 ...
 *
 * Validates the token (loaded by {@see \Hashtopolis\inc\agentapi\auth\TokenAuthMiddleware}),
 * stores the client signature, updates the agent's activity fields, and
 * returns server config (multicast, timeout, version).
 */
final class LoginAction implements AgentAction {
    public function __invoke(Request $request, Response $response): ResponseInterface {
        ...
        if (!isset($body[PQueryLogin::CLIENT_SIGNATURE])) {

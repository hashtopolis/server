...
class Agent extends AbstractModel {
	...
	function __construct($agentId, $name, $uid, $os, $cpuType, $gpuBrand, $gpuDriver, $gpus, $hcVersion, $cmdPars, $wait, $ignoreErrors, $isActive, $isTrusted, $token, $lastAct, $lastTime, $lastIp, $userId, $cpuOnly) {

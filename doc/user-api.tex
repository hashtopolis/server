...
\begin{document}
	...
	\section*{Tasks (\textit{task})}
		...
		\subsection*{\textit{setSupertaskName}}
			Change the name of a supertask which is in the supertask list, but not running yet.
			{
				\color{blue}
				\begin{verbatim}
				{
		...
		\subsection*{\textit{setRunningSupertaskName}}
			Set the name of a running supertask.
			{
				...
				{
				  "section": "task",
				  "request": "setRunningSupertaskName",
				  "supertaskId": 43,
				  "name": "New Running Supertask Name",
				  "accessKey": "mykey"
				}
				\end{verbatim}
			}
		...
		\subsection*{\textit{deleteSupertask}}
			Deletes a configured supertask which is not running. The contained preconfigured tasks are only deleted if they were from a mask import.
			{
				\color{blue}
				\begin{verbatim}
				{
		...
		\subsection*{\textit{deleteRunningSupertask}}
			Delete a running supertask. This includes all contained subtasks.
			{
				...
				{
				  "section": "task",
				  "request": "deleteRunningSupertask",
				  "supertaskId": 43,
				  "accessKey": "mykey"
				}
				\end{verbatim}
